...
space = {
         'fp_2_dim':hp.choice('fp_2_dim', [128,256,512,768]),
         'nhid':hp.quniform('nhid', low=40, high=80, q=10),
         ...
         'dropout':hp.quniform('dropout', low=0.0, high=0.6, q=0.1),
         'dropout_gat':hp.quniform('dropout_gat', low=0.0, high=0.6, q=0.1)
...
def fn(space):
    ...
    list = ['fp_2_dim','batch_size','nhid','nheads','hidden_size']
    for one in list:
